        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="{{ route('admin.centers.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="fee_percent" value="{{ old('fee_percent') }}">
                    @error('fee_percent')
                      <p>{{ $message }}</p>
                    @enderror
                  </div>
